...
export "HELLO_CONFIG=${HELLO_HOME}/s1p-hello-setup/manual/config"
...
kubectl create -f ${HELLO_HOME}/s1p-hello-service/create-hello-service.yaml
kubectl create -f ${HELLO_HOME}/s1p-hello-client/create-hello-client.yaml
